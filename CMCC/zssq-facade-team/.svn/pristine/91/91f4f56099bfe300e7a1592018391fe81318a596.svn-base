...
public interface ITeamInfoService {
	...
	/**
	 * @Function teamArchiving
	 * @Description 归档标志变更
	 * @param teamCode 班组编码
	 * @param archiving 2归档中 0归档失败
	 * @throws BusinessException
	 */
	 ...
	 * @throws BusinessException
	 */
	public List<String> selectTeamCodesByOrgs(List<String> orgCodes) throws BusinessException;

...
public class BaseSysOrgInfo {
    ...
    public void setManOrgCode(String manOrgCode) {
        this.manOrgCode = manOrgCode == null ? null : manOrgCode.trim();
    }
    ...
    public void setSysOrgType(String sysOrgType) {
        this.sysOrgType = sysOrgType == null ? null : sysOrgType.trim();
    }
    ...
    public void setSysOrgOrder(String sysOrgOrder) {
        this.sysOrgOrder = sysOrgOrder == null ? null : sysOrgOrder.trim();
    }
    ...
    public void setKcParentCode(String kcParentCode) {
        this.kcParentCode = kcParentCode == null ? null : kcParentCode.trim();
    }
}
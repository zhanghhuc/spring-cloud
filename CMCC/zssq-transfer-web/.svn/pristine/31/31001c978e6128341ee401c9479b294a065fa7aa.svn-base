...
/**
 * 
 * @ClassName: RelationSubjectResource  
 * @Description: 内容资源  
 * @author ZKZ  
 * @date 2017年4月18日  
 *
 */
public class RelationSubjectResource implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	private Long id = 0L;
    private String subjectResCode = "";
    ...
    public void setSubjectResCode(String subjectResCode) {
        this.subjectResCode = subjectResCode == null ? null : subjectResCode.trim();
    }

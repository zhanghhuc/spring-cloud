...
public class BlogModel implements Serializable {
	...
	private String userCode; // 发布人编号
	private String dynamicCode; // 动态编号
	private Byte blogSource; // 来源
	private String sourceBlogCode; // 来源博客编号
	private String sourceUserCode; // 来源博客发布人编号
    private Byte sourceBlogDepend; // 来源博客从属关系
    private String sourceTeamCode; // 来源所属班组编号
	private Byte blogDepend; // 从属关系
	...
	private Long blogPublishTime; // 发布时间
	private String contentInfo; // 正文
	...
	private Long operateTime; // 收藏等操作时间
	...
	public void setSourceBlogCode(String sourceBlogCode) {
		this.sourceBlogCode = sourceBlogCode;
	}

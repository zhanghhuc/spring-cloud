...
public class VoteInfo {
    ...
    public void setSponsorOrgCode(String sponsorOrgCode) {
        this.sponsorOrgCode = sponsorOrgCode == null ? null : sponsorOrgCode.trim();
    }

    public Byte getVoteStatus() {
        return voteStatus;
    }

    public void setVoteStatus(Byte voteStatus) {
    ...
    public void setVoteExplain(String voteExplain) {
        this.voteExplain = voteExplain == null ? null : voteExplain.trim();
    }
}
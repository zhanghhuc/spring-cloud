...
public interface VoteInfoMapper {
	...
	void batchUpdateCommentCount(List<CountResult> commentList);

	void batchUpdateJoinCount(List<CountResult> joinList);

	List<VoteInfo> selectVoteInfoForAuth(int i, int count);
	 ...
	 * @return
	 */
	VoteInfo selectBaseVoteInfo(String voteCode);

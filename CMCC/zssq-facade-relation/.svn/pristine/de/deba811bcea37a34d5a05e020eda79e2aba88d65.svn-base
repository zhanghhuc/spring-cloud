...
/**
 * 
 * @ClassName: RelationPortalHotModel  
 * @Description: 门户 非班组  
 * @author sry  
 * @date 2017年4月20日  
 *
 */
public class RelationPortalHotModel implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	private String hotCode;			//热点编号
	private String subjectCode;		//内容编号
	private Byte subjectClass;	//内容类型：1.微博；2.博客；3.投票；4.活动；5.新闻公告；
	private String userCode;		//内容发布人编号
	private String teamCode;		//班组code
	private String userName;		//内容发布人名称
	private String userPhotoUrl;	//内容发布人头像链接
	private Byte subjectDepend;//从属关系：1.个人；2.班组
	private String orgCode;			//内容发布人所属组织编号
	private String orgName;			//内容发布人所属组织名称
	private Long subjectPublishTime;	//内容发布时间
	private String subjectTitle;	//内容标题
	private String subjectDigest;	//内容摘要
	private String subjectUrl;	//内容图片链接
	private Long subjectBeginTime;//开始时间
	private Long subjectEndTime;	//结束时间
	private Byte subjectSource;	//内容来源：1.原创；2.转发
	private Byte subjectStatus;	//活动使用：1.草稿；2.待审核；3.已驳回；4.未开始；5.预热中；6.进行中；7.已结束 8.已下线
	private String sourceCode;		//来源编号
	private String sourceUserCode;	//来源发布人编号
	private String sourceTeamCode; //来源班组code
	private String sourceUserName;	//来源发布人名称
	private String sourceUserPhotoUrl;//来源发布人头像链接
	private Byte sourceDepend;//来源从属关系：1.个人；2.班组
	private String sourceOrgCode;	//来源发布人所属组织编号
	private String sourceOrgName;	//来源发布人所属组织名称
	private Long sourcePublishTime;//来源发布时间
	private Integer sourceIsDelete;	//来源是否删除
	private Byte sourceIsShield;//来源是否屏蔽
	private String contentTips;		//转发心得
	private Integer teamQualityNum;	//班组置精次数
	private Integer groupQualityNum;//集团级别置精次数
	private Integer provinceQualityNum;//省级别置精次数
	private Integer cityQualityNum;	//市级别置精次数
	...
	private Integer hotIsLike;		//是否点赞：0.否；1.是
	private Integer hotIsCollect;	//是否收藏：0.否；1.是
	private List<ResourceModel> resList;//资源列表
	...
	public String getSourceUserPhotoUrl() {
		return sourceUserPhotoUrl;
	}
	public void setSourceUserPhotoUrl(String sourceUserPhotoUrl) {
		this.sourceUserPhotoUrl = sourceUserPhotoUrl;
	}
	...
	public Integer getSourceIsDelete() {
		return sourceIsDelete;
	}
	public void setSourceIsDelete(Integer sourceIsDelete) {
	...
	public Integer getHotIsLike() {
		return hotIsLike;
	}
	public void setHotIsLike(Integer hotIsLike) {
		this.hotIsLike = hotIsLike;
	}
	public Integer getHotIsCollect() {
		return hotIsCollect;
	}
	public void setHotIsCollect(Integer hotIsCollect) {
		this.hotIsCollect = hotIsCollect;
	}
	...
	public void setResList(List<ResourceModel> resList) {

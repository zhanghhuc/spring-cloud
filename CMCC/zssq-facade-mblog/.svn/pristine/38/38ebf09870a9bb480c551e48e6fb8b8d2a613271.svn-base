...
public class MblogNum extends BaseEntity{
    ...
    */  
	...
	private String mblogNumCode = "";
	
	private String subjectCode = "";
	
	private Byte numSource = 0;
	...
	public String getMblogNumCode() {
		return mblogNumCode;
	}

	public void setMblogNumCode(String mblogNumCode) {
		this.mblogNumCode = mblogNumCode;
	}
	...
	public Byte getNumSource() {
		return numSource;
	}

	public void setNumSource(Byte numSource) {

...
public class BlogService {
	...
	@DataSource(DataSourceConstants.DB2_BLOG)
	public int getSourceMySQLBlogCount() {
		// 拼接SQL
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT ");
		sql.append("COUNT(*) ");
	 ...
	 */
	@DataSource(DataSourceConstants.DB2_BLOG)
	public List<DB2Blog> getSourceDB2BlogList(int pageNo, int pageSize) {
		// 拼接SQL
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT ");
	...
	@DataSource(DataSourceConstants.DB2_BLOG)
	public List<DB2Blog> getSourceMySQLBlogList(int pageNo, int pageSize) {
		// 拼接SQL
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT ");
		sql.append("bl.blog_id AS blogId, ");

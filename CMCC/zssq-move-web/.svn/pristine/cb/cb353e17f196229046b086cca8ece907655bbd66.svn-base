...
/**
 * 
 * @ClassName: RelationSubjectInfo  
 * @Description: 内容信息  
 * @author ZKZ  
 * @date 2017年4月18日  
 *
 */
public class RelationSubjectInfo implements RowMapper<RelationSubjectInfo>,Serializable {
    ...
    private Byte subjectDepend = 0;
    private String teamCode = "";
    private String userCode = "";
    private Long subjectPublishTime = 0L;
    private String subjectTitle = "";
    private Byte sourceDepend = 0;
    private String sourceTeamCode = "";
    private String subjectUrl = "";
    private Byte subjectSource = 0;
    private String sourceCode = "";
    private String sourceUserCode = "";
    private Long sourcePublishTime = 0L;
    private Byte sourceIsDelete = 0;
    private Byte sourceIsShield = 0;
    private Byte subjectIsDelete = 0;
    private Byte subjectIsShield = 0;
    private Byte subjectStatus = 0;
    private Long subjectBeginTime = 0L;
    private Long subjectEndTime = 0L;
    ...
    public void setSourceTeamCode(String sourceTeamCode) {
        this.sourceTeamCode = sourceTeamCode == null ? null : sourceTeamCode.trim();
    }
    ...
    public void setSubjectUrl(String subjectUrl) {
        this.subjectUrl = subjectUrl == null ? null : subjectUrl.trim();
    }
    ...
    public void setSubjectDigest(String subjectDigest) {
        this.subjectDigest = subjectDigest == null ? null : subjectDigest.trim();
    }
    ...
    public void setContentTips(String contentTips) {
        this.contentTips = contentTips == null ? null : contentTips.trim();
    }
	@Override
	public RelationSubjectInfo mapRow(ResultSet rs, int arg1) throws SQLException {
		RelationSubjectInfo relationSubjectInfo = new RelationSubjectInfo();
		relationSubjectInfo.setSubjectCode(rs.getString("subject_code"));
		relationSubjectInfo.setCreateTime(rs.getLong("create_time"));
		relationSubjectInfo.setOrgCode(rs.getString("org_code"));
		relationSubjectInfo.setTenantCode(rs.getString("tenant_code"));

 ...
 *
 */
public class BlogData implements RowMapper<BlogData>,Serializable {
	...
	@Override
	public BlogData mapRow(ResultSet arg0, int arg1) throws SQLException {
		BlogData blogData = new BlogData();
		blogData.setCommentNum(arg0.getInt("comment_num"));
		blogData.setReadNum(arg0.getInt("read_num"));
		blogData.setForwardNum(arg0.getInt("forward_num"));
		blogData.setLikeNum(arg0.getInt("like_num"));
		blogData.setCreateTime(arg0.getLong("create_time"));

...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	/**
	 * 获得当前日期0点0分0秒的long值
	 * @Function getCurDayStart
	 * @Description 
	 * @return
	 */
	public static long getCurDayStart() {
		return getDayStart(new Date()).getTime();
	}
	
	public static void main(String[] args) {
		//System.out.println(getCurDayStart());
	...
	/**
	 * 获得当前日期23点59分59秒的long值
	 * @Function getCurDayEnd
	 * @Description 
	 * @return
	 */
	public static long getCurDayEnd(){
	...
	public static double getMonthNumbersBetween(Date minDate, Date maxDate) throws ParseException{
			String sminDate=getStrFormTime(DATE_FORMAT_DATEONLY,minDate);
			String smaxDate=getStrFormTime(DATE_FORMAT_DATEONLY,maxDate);
			return getMonthBetween( sminDate,  smaxDate).size();
	}
	...
	// string类型转换为date类型
	 ...
	 // date类型转换为String类型
		 ...
		 * @Description 获取 yyyy-MM-dd HH:mm:ss 的long值不包含毫秒值
		 * @return
		 */
		public static Long getFormatDateLong(){
			try {
				SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
				return sdf.parse(getFormatDate()).getTime();
			} catch (ParseException e) {
				e.printStackTrace();
				return null;
			}
	 ...
	 * 
	 * @Title: isValidDate
	 * @Description: 验证日期格式("yyyy-MM-dd HH:mm:ss")
	 * @param str
	 * @return boolean
	 *
	 */
	 ...
	 * @Description 把long类型的时间转换成格式化的时间字符串
	 * @param dateLong
	 * @return
	 */
	public static String getDateString(Long dateLong,String format) {

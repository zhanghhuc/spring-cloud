...
public class ComplaintInfo implements Serializable {
	private static final long serialVersionUID = -6227058382245424465L;

	private Long id;

    private String complaintInfoCode;
    ...
    public String getComplaintInfoCode() {
        return complaintInfoCode;
    }

    public void setComplaintInfoCode(String complaintInfoCode) {
        this.complaintInfoCode = complaintInfoCode == null ? null : complaintInfoCode.trim();
    }

	...
	public ResultJSON addNewsInfoComment(@RequireValid NewsCommentVo newsCommentVo) throws BusinessException {
		...
		try {
			...
			if (null != newsInfoComment) {
				RelationDataVO relationDataVO = generateRelationDataVO(newsInfoComment.getCommentCode(), RelationConstants.RELATION_THIRD_DATANUM_TYPE_COMMENT, 1);
	...
	public ResultJSON deleteNewsInfoComment(@RequireValid NewsCommentDeleteVo newsCommentDeleteVo) throws BusinessException {
		...
		try {
			...
			if (flag) {
				...
				RelationDataVO relationDataVO = generateRelationDataVO(newsCommentModel.getCommentCode(), RelationConstants

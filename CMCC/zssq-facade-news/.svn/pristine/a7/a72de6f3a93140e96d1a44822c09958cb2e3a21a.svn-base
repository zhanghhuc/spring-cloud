...
public class NewsCommentModel implements Serializable {
    ...
    private Integer commentReportNum;
    ...
    public Integer getCommentReportNum() {
        return commentReportNum;
    }

    public void setCommentReportNum(Integer commentReportNum) {
        this.commentReportNum = commentReportNum;
    }

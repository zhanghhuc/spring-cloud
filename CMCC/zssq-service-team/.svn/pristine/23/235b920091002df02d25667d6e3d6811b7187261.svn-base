...
public interface TeamInfoMapper {
    ...
    /**
     * @Function selectCodesByOrg
     * @Description 根据组织机构编码返回班组编码集合
     * @param orgCode
     * @return
     */
    List<String> selectCodesByOrg(String orgCode);
    
    
    /**
     * @Function selectTeamRecords
     * @Description 查询班组归档列表
     * @param record
     * @return
     */
    List<TeamInfo> selectTeamRecords(TeamInfo record);
    
    
    /**
     * @Function selectTeamRecordCount
     * @Description 查询班组归档列表(数量)
     * @param record
     * @return
     */
    int selectTeamRecordCount(TeamInfo record);
    
    /**
     * @Function selectTeamCodesByOrgs
     * @Description 根据组织机构编码,返回班组编码
     * @param orgCode
     * @return
     */
    List<String> selectTeamCodesByOrgs(List<String> orgCode);
    
    /**
     * @Function selectDisTeamCodes
     * @Description 返回解散的班组编码集合
     * @return
     */
    List<String> selectDisTeamCodes(String tenantCode);
}
...
import com.example.shiro.filter.FormFilter;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/test/login", "anon");//anon 可以理解为不拦截
        filterChainDefinitionMap.put("/page/login", "anon");//anon 可以理解为不拦截
